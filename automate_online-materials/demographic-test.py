...
highest_earning_countries = df[(df['salary'] == '>50K')]['country'].value_counts()
print(highest_earning_countries.head)
print(highest_earning_countries.idxmax())
print(df[(df['salary'] == '>50K')]['country'].value_counts().idxmax())

highest_earning_country = df[(df['salary'] == '>50K')]['country'].value_counts().idxmax()

highest_earning_country_percentage = (df[(df['salary'] == '>50K')]['country'].value_counts().max()*100)/len(df['salary'])
print(highest_earning_country_percentage,'%')

df_serbia_high_salary = df[(df['salary'] == '>50K') & (df['country'] == 'Serbia')]
print(df_serbia_high_salary)
top_IN_occupation = df_serbia_high_salary['occupation'].value_counts().index[0]
